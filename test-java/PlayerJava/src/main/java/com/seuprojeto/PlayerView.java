...
public class PlayerView {
    ...
    private Slider timeSlider; // Adicionado: Slider de tempo
    ...
    private void createView() {
        ...
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            ...
            public void positionChanged(MediaPlayer mediaPlayer, float newPosition) {
                // Sincroniza o slider com a posição de reprodução.
                Platform.runLater(() -> timeSlider.setValue(newPosition));
            }
        });
    ...
    private VBox createControlsBox() {
        ...
        // Botão de voltar e Label do título do canal
        ...
        timeSlider.setOnMousePressed(e -> mediaPlayer.controls().setPosition((float) timeSlider.getValue()));
        timeSlider.setOnMouseDragged(e -> mediaPlayer.controls().setPosition((float) timeSlider.getValue()));

        HBox topControls = new HBox(15, backButton, channelTitleLabel);
        topControls.setAlignment(Pos.CENTER_LEFT);
        HBox.setHgrow(channelTitleLabel, Priority.ALWAYS);

        HBox mainControls = new HBox(10, playPauseButton, stopButton, volumeLabel, volumeSlider, audioTrackBox, subtitleTrackBox);
        mainControls.setAlignment(Pos.CENTER);
        
        // Sliders de ajuste de imagem
        ...
        // VBox que contém todos os controles
        VBox allControls = new VBox(10, topControls, timeSlider, mainControls, imageControls);
